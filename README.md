...
Tailwind CSS を採用している理由:

- 余白、角丸、行間、サイズ指定を小さなユーティリティで揃えやすく、`8px` グリッドの設計を崩しにくい
- 画面全体で spacing の粒度を統一しやすいため、密度が揃って見た目が整いやすい
- 細かな調整を JSX 上で素早く試せるので、PoC 段階でも「とりあえず動くUI」で終わらず、素直に見た目を磨きやすい
